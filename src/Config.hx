class Config {
    public static inline var SCREEN_WIDTH:Int = 1920;
    public static inline var SCREEN_HEIGHT:Int = 1080;
    public static inline var SCREEN_CENTER_X:Int = 960;
    public static inline var SCREEN_CENTER_Y:Int = 540;
    ...
    public static inline var ENERGY_START:Int = 80;
    ...
    public static inline var SPAWN_COUNT_LIMIT:Int = 20;
    public static inline var SPAWN_COST:Int = 0;
}
